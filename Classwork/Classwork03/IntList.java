   ...
   public class IntList implements IntListInterface {
     ...
     // main() method to test all the methods in the class
      public static void main( String[] args ) {
         ...
         System.out.println( "List size: " + list.getSize() );
         System.out.println( "Contents : " + list.toString() );
         System.out.println( list.removeValueAtIndex( 7 ) );   // should return the value 23
         System.out.println( "List size: " + list.getSize() );
         System.out.println( "Contents : " + list.toString() );
         list.append( 73 );
         list.append( 79 );
         ...
         System.out.println( "List size: " + list.getSize() );
         System.out.println( "Contents : " + list.toString() );
         System.out.println( list.removeValueAtIndex( 7 ) );   // should return the value 29
         System.out.println( "List size: " + list.getSize() );
         System.out.println( "Contents : " + list.toString() );
         list.insertValueAtIndex( 101, 11 );
         System.out.println( "List size: " + list.getSize() );
         System.out.println( "Contents : " + list.toString() );
         list.append( 123 );
         list.append( 129 );
